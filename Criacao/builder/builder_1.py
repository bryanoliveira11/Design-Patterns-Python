...
class UserDirector:
    ...
    def with_address(self, firstname: str, lastname: str,
                     age: int, address: list):
        self._builder.add_firstname(firstname)\
            .add_lastname(lastname)\
            .add_age(age)\
            .add_address(address)
...
if __name__ == "__main__":
    ...
    user1 = user_director.with_age('User', 'One', 18)
    user2 = user_director.with_address('User', 'Two', 18, ['Rua 1', 'Rua2'])
    print(user1)
    print(user2)
