...
if __name__ == '__main__':
    ...
    joao = Person('joao', chatroom)
    maria = Person('maria', chatroom)
    jose = Person('jose', chatroom)

    chatroom.add(joao)
    chatroom.add(maria)
    chatroom.add(jose)

    joao.broadcast('mensagem teste')
    maria.broadcast('mensagem')

    joao.send_direct('maria', 'mensagem teste')
